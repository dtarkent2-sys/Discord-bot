const fragments = [];
  fragments.push(persona.name);
  fragments.push('Think of yourself as the group chat\'s go-to person for market talk, but you\'re down to chat about literally anything.');
  fragments.push(persona.vibe);
  const lines = [
    'Vibe: ${persona.vibe}',
    '',
    'How you talk:',
  ...
  lines.forEach(line => fragments.push(line));
